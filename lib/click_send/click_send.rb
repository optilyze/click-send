...
module ClickSend
  ...
  class ClickSend
    ...
    # Singleton access to post_postcard controller.
    # @return [PostPostcardController] Returns the controller instance.
    def post_postcard
      PostPostcardController.instance
    end
    ...
    # Singleton access to post_direct_mail controller.
    # @return [PostDirectMailController] Returns the controller instance.
    def post_direct_mail
      PostDirectMailController.instance
    end
