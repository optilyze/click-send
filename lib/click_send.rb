...
require_relative 'click_send/click_send.rb'
...
require_relative 'click_send/models/post_letter.rb'
require_relative 'click_send/models/fax_message.rb'
require_relative 'click_send/models/mms_message_collection.rb'
require_relative 'click_send/models/post_postcard.rb'
...
require_relative 'click_send/models/post_direct_mail.rb'
require_relative 'click_send/models/post_direct_mail_area.rb'
require_relative 'click_send/models/fax_message_collection.rb'
require_relative 'click_send/models/sms_template.rb'
require_relative 'click_send/models/account_verify.rb'
require_relative 'click_send/models/account_forgot_password_verify.rb'
require_relative 'click_send/models/contact_list_import.rb'
require_relative 'click_send/models/email_sms_address.rb'
require_relative 'click_send/models/reseller_account_transfer_credit.rb'
require_relative 'click_send/models/credit_card.rb'
require_relative 'click_send/models/post_recipient.rb'
require_relative 'click_send/models/subaccount.rb'
require_relative 'click_send/models/file_content.rb'
...
require_relative 'click_send/controllers/post_postcard_controller.rb'
require_relative 'click_send/controllers/upload_controller.rb'
require_relative 'click_send/controllers/post_direct_mail_controller.rb'
